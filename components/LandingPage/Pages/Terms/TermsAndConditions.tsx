    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="mx-auto max-w-7xl px-6 py-12 space-y-10">
        ...
        <div>
                    ...
                    <p className="text-[12px] sm:text-base text-[#767676] leading-relaxed">
        ...
        {/* 2 */}
        <div>
          <h2 className="text-sm sm:text-base md:text-lg font-semibold text-[#3A3A3A] mb-2">2. Service Description</h2>
          <p className="text-[12px] sm:text-base text-[#767676] mb-3">Psychology Buddy is a school-based mental health support platform designed to:</p>
          <ul className="space-y-1.5">
            {[
              ...
              <li key={i} className="flex items-start gap-2 text-[12px] sm:text-base text-gray-600">
        ...
        <div>
                    ...
                    <p className="text-[12px] sm:text-base text-[#767676] mb-1">
            <span className="text-sm sm:text-base md:text-lg font-semibold text-gray-800">Student Users:</span> Must be enrolled in a participating school. Students under 13 require parental consent and consent from their school. Students 13 and older may use the Platform with school consent.
          </p>
                    <p className="text-[12px] sm:text-base text-gray-600 mb-1">
            <span className="font-semibold text-gray-800">Adult Users (Parents/Educators):</span> Must be at least 18 years old to create an account.
                    ...
                    <p className="text-[12px] sm:text-base text-gray-600 mb-3">
        ...
        <div>
          ...
          <ul className="space-y-1.5">
            {[
              ...
              <li key={i} className="flex items-start gap-2 text-[12px] sm:text-base text-[#767676]">
                <span className="mt-2 h-1.5 w-1.5 rounded-full bg-gray-500 shrink-0" />
                {item}
              </li>
            ))}
        ...
        {/* 5 */}
        <div>
          <h2 className="text-sm sm:text-base md:text-lg font-semibold text-[#3A3A3A] mb-2">5. Acceptable Use Policy</h2>
                    <p className="text-[12px] sm:text-sm text-gray-600 mb-3">You agree not to:</p>
          <ul className="space-y-1.5">
            {[
        ...
        <div>
          <h2 className="text-sm sm:text-base md:text-lg font-semibold text-[#3A3A3A] mb-2">6. Mental Health Support & Crisis Resources</h2>
        ...
        <div>
          <h2 className="text-sm sm:text-base md:text-lg font-semibold text-[#3A3A3A] mb-2">7. Intellectual Property</h2>
          {/* <p className="text-sm text-gray-600 mb-3">You agree not to:</p> */}
          <ul className="space-y-1.5">
            {[
        ...
        <div>
          <h2 className="text-sm sm:text-base md:text-lg font-semibold text-[#3A3A3A] mb-2">8. Limitation of Liability</h2>
          {/* <p className="text-sm text-gray-600 mb-3">You agree not to:</p> */}
          <ul className="space-y-1.5">
            {[
        ...
        <div>
          <h2 className="text-sm sm:text-base md:text-lg font-semibold text-[#3A3A3A] mb-2">9. Termination</h2>
          {/* <p className="text-sm text-gray-600 mb-3">You agree not to:</p> */}
          <ul className="space-y-1.5">
            {[
        ...
        <div>
          <h2 className="text-sm sm:text-base md:text-lg font-semibold text-[#3A3A3A] mb-2">10. Changes to Terms</h2>
          {/* <p className="text-sm text-gray-600 mb-3">You agree not to:</p> */}
          <ul className="space-y-1.5">
            {[
        ...
        <div>
          <h2 className="text-sm sm:text-base md:text-lg font-semibold text-[#3A3A3A] mb-2">11. Governing Law</h2>
          {/* <p className="text-sm text-gray-600 mb-3">You agree not to:</p> */}
          <ul className="space-y-1.5">
            {[
