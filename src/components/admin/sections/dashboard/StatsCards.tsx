...
function StatsCards({ stats, loading }: StatsCardsProps) {
  const cards: Array<{
    ...
    { title: "Total Students", value: stats.totalStudents, icon: "users", color: "bg-[#3B82F6]/10 text-[#3B82F6]" },
    { title: "Today's Check-ins", value: stats.checkinsToday, icon: "checkins", color: "bg-[#10B981]/10 text-[#10B981]" },
    { title: "Counselling Sessions", value: stats.activeSessions, icon: "sessions", color: "bg-[#E2E8F0] text-[#64748B]" },
    { title: "High & Critical Alerts", value: stats.highRiskAlerts, icon: "alerts", color: "bg-[#EF4444]/10 text-[#EF4444]" },
    { title: "Resources Published", value: stats.totalResources, icon: "articles", color: "bg-[#E2E8F0] text-[#64748B]" },
  ];
