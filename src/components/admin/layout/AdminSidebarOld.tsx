...
import { StudentsManagementSection } from '../sections/StudentsManagementSection';
// import { PsychoEducationSection } from './sections/PsychoEducationSection';
// import { SelfHelpSection } from './sections/SelfHelpSection';
...
export function UnifiedAdminDashboard({ activeSection: propActiveSection }: UnifiedAdminDashboardProps = {}) {
  ...
  const renderActiveSection = () => {
    switch (activeSection) {
      ...
      case 'students':
        return <StudentsManagementSection />;
      // case 'psycho-education':
      //   return <PsychoEducationSection />;
      // case 'self-help':
      //   return <SelfHelpSection />;
      // case 'analytics':
